...
class CashcardApplicationTests {
	...
	void shouldCreateANewCashCard() {
		...
		assertThat(amount).isEqualTo(250.00); /*both specified in creation of card*/
	}
	...
	void shouldUpdateAnExistingCashCard() {
		...
		ResponseEntity<Void> response = restTemplate
				.withBasicAuth("sarah1", "abc123")
				.exchange("/cashcards/99", HttpMethod.PUT, request, Void.class); /*putForEntity doesnt exist, we use thisq*/
